...
util.showThisRoute = function(itAccess, currentAccess) {
  return Array.isArray(itAccess)
    ? itAccess.includes(currentAccess)
    : itAccess === currentAccess
}
...
util.openNewPage = function(vm, name, argu, query) {
  let pageOpenedList = vm.$store.state.app.pageOpenedLists || []
