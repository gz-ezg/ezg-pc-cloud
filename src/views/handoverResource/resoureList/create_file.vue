        ...
        >
            <Form ref="formValidate" :model="formValidate" :label-width="120">
                ...
                <FormItem label="文件类型：" prop="customerFileTypeId">
                    <Select v-model="formValidate.customerFileTypeId" placeholder="选择文件类型" filterable>
