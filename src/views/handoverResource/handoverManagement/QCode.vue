...
export default {
    ...
    created() {
        ...
        _self.$bus.on("OPEN_INNER_QCODER", (e)=>{
            ...
            // let url = "https://open.weixin.qq.com/connect/oauth2/authorize?appid=ww35cf36c59582b438&redirect_uri=http://cloud.zgcfo.com/api/system/apiWechatQuickOfficeAuthLogin&response_type=code&scope=SCOPE&agentid=1000004&state=STATE#wechat_redirect"
           let url = `${e}`
            _self.get_code(url)
        })
