<template>
  <div>
    ...
    <Modal title="新增" v-model="openCreateProduct" width="500">
    ...
    <Modal title="编辑" v-model="openEditProduct" width="500">
...
const url = '/customer/program/ProgramProductList';
export default {
  ...
  data() {
    return {
      ...
      ruleValidate: {
        productname: [{ required: true, message: '请补全！', trigger: 'change' }],
        concessions: [{ required: true, message: '请补全！', trigger: 'change' }],
        declaredate: [{ required: true, message: '请补全！', trigger: 'change' }]
      }
    };
  },
  methods: {
