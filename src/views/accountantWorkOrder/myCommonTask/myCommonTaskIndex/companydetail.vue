                                ...
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="companyname" label="公司名称：">
                                            <Input type="text" size="small" v-model="task_message.companyname" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="10">
                                        <FormItem prop="NAME" label="归属客户：">
                                            <Input type="text" size="small" v-model="task_message.NAME" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <!-- <Col span="2">
                                 ...
                                 <Row :gutter="24">
                                    ...
                                    <Col span="20">
                                        <FormItem prop="serviceaddress" label="服务地址：">
                                            <Input type="text" size="small" v-model="task_message.serviceaddress" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                </Row>
                                 <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="TEL" label="客户电话：">
                                            <Input type="text" size="small" v-model="task_message.TEL" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="10">
                                        <FormItem prop="cluesource" label="企业来源：" >
                                            <Select transfer v-model="task_message.cluesource" disabled transfer>
                                                <!--    使用何种方式渲染这个选择队列呢  -->
                                ...
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="enterprisestatus" label="企业状态：">
                                            <Select transfer v-model="task_message.enterprisestatus" disabled transfer> 
                                ...
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="taxtype" label="年度纳税评级：">
                                            <Select transfer v-model="task_message.taxtype" disabled transfer>
                                    ...
                                    <Col span="10">
                                        <FormItem prop="transactiontype" label="企业交易状态：">
                                            <Select transfer v-model="task_message.transactiontype" disabled transfer> 
                                ...
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="bankcode" label="机构代码：">
                                            <Input type="text" size="small" v-model="task_message.bankcode" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="10">
                                        <FormItem prop="basicbankcode" label="信用机构代码：">
                                            <Input type="text" size="small" v-model="task_message.basicbankcode" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="basicbank" label="基本户开户行：" disabled>
                                            <Input type="text" size="small" v-model="task_message.basicbank" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                </Row>
                                ...
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="cnumber" label="国税号码：">
                                            <Input type="text" size="small" v-model="task_message.cnumber" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="10">
                                        <FormItem prop="pnumber" label="地税号码：">
                                            <Input type="text" size="small" v-model="task_message.pnumber" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                </Row>
                                <Row :gutter="16">
                                    ...
                                    <Col span="10">
                                        <FormItem prop="cpassword" label="国税密码：">
                                            <Input type="text" size="small" v-model="task_message.cpassword" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="10">
                                        <FormItem prop="ppassword" label="地税密码：">
                                            <Input type="text" size="small" v-model="task_message.ppassword" placeholder="" disabled>
                                            </Input>
                                        </FormItem>
                                    </Col>
                                </Row>
