                                ...
                                <Row :gutter="12">
                                    <Col span="8">
                                        <FormItem prop="companyName" label="公司名称：">
                                            <Input type="text" size="small" v-model="formInline.companyName" placeholder="">
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <Col span="8">
                                        <FormItem prop="server_realname" label="服务人员：">
                                            <Input type="text" size="small" v-model="formInline.server_realname" placeholder="">
                                            </Input>
                                        </FormItem>
                                    </Col>
                                    <!-- <Col span="12">
                                        <FormItem prop="accmanager_realname" label="会计经理名称：">
                                            <Input type="text" size="small" v-model="formInline.accmanager_realname" placeholder="">
                                            </Input>
                                        </FormItem>
                                    </Col> -->
                                    <Col span="8">
                                        <FormItem prop="followby_realname" label="跟进人：">
                                            <Input type="text" size="small" v-model="formInline.followby_realname" placeholder="">
                                            </Input>
                                        </FormItem>
                                    </Col>
                                </Row>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                let _self = this
                let url = '/order/cycle/service/record/list?sortField=createdate&service_type=kjdj&page=' + _self.page + '&pageSize=' + _self.pageSize + '&service_status=stop' +'&companyName=' + _self.formInline.companyName + '&server_realname=' + _self.formInline.server_realname + '&accmanager_realname=' + _self.formInline.accmanager_realname + '&followby_realname=' + _self.formInline.followby_realname + '&begin_end_period=' + _self.formInline.begin_end_period + "&end_end_period=" + _self.formInline.end_end_period
            ...
            ksfw() {
                ...
                if (_self.id.id == '' || _self.id.id == undefined) {
                    _self.$Message.warning('请选择要开始服务的项目')
                } else {
                    this.$Modal.confirm({
                    title: '提示信息',
