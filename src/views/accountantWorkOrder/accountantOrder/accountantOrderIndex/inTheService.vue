<template>
    <Card style="padding-bottom:200px">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                let _self = this
                let url = '/order/cycle/service/record/list?sortField=createdate&service_type=kjdj&page=' + _self.page + '&pageSize=' + _self.pageSize + '&service_status=inservice'+'&companyName=' + _self.formInline.companyName + '&server_realname=' + _self.formInline.server_realname + '&accmanager_realname=' + _self.formInline.accmanager_realname + '&followby_realname=' + _self.formInline.followby_realname + '&begin_end_period=' + _self.formInline.begin_end_period + "&end_end_period=" + _self.formInline.end_end_period
            ...
            openFieldByCompanyId(){
                ...
                if (!_self.id) {
                    ...
                    _self.$bus.emit('OPEN_FIELD_LIST_BY_COMPANYID', [_self.id.company_id,_self.id.CompanyName[0].name])
                }
            }
        },
        mounted() {
