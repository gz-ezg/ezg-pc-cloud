              ...
              <Row>
                ...
                <Col span="6">
                  <FormItem label="服务部门：" prop="departname">
                    <Select
                      v-model="SearchValidate.departname"
                      size="small"
                      transfer
                      @on-change="getData"
                    >
    ...
    <Row>
      <ButtonGroup>
        <Button
          ...
          @click="ksfw"
          v-permission="['bookkeepingAgency.startService']"
        >开始服务</Button>
        <Button
          type="primary"
          icon="information-circled"
          v-permission="['accounterManager.share']"
          @click="fpkj"
        >变更会计</Button>
        ...
        <Button
          type="primary"
          icon="information-circled"
          v-permission="['accounterManager.upgrade']"
          @click="service_level"
        >服务升级</Button>
        <Button
          type="primary"
          icon="information-circled"
          v-permission="['accounterManager.logout']"
          @click="layout"
        >公司注销</Button>
