...
<Card>
    ...
    <Row style="margin-top: 10px;">
        <Table ref="selection" highlight-row size="small" :loading="loading" @on-row-click="selectrow" :columns="header" :data="data"></Table>
        <Page size="small" :total="pageTotal" show-total show-sizer show-elevator @on-change="pageChange" @on-page-size-change="pageSizeChange" placement="top" style="margin-top: 10px"></Page>
    </Row>
        ...
        return {
            ...
            header: [{
                    ...
                    render: (h, params) => {
                        return h(
                            "div", {},
                            this.cservicest_map.get(params.row.service_status)
                        );
                    },
                },
                {
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        return h(
                            "div", {},
                            this.managestatus_map.get(params.row.managestatus)
                        );
                    },
                },
                {
