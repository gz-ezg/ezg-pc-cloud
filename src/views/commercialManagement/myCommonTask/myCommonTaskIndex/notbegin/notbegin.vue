...
export default {
                            ...
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            // console.log(params)
                                            Bus.$emit('showcompanydetail2',params)
                                        }
                                    }
                                }, '[查看公司]'),
                                h('Button', {
    ...
    methods:{
        getData(){
            var _self = this
            var url = 'api/order/workOrderList?state=unstarted'
            var config = {
                params:{
                    page:_self.page,
        ...
        showdetail2(){
            if(this.current_row != ''){
                Bus.$emit('myCommonTask2',this.current_row)
            }else{
        ...
        showflow2(){
            if(this.current_row != ''){
                Bus.$emit('myflow2',this.current_row)
            }else{
