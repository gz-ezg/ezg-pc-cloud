    ...
    <Card>
        <Row>
            <ButtonGroup style="float:left">
                <Button type="primary" icon="information-circled" @click="showdetail1">查询详情</Button>
                <Button type="primary" icon="ios-color-wand-outline" @click="showflow1">流转</Button>
...
export default {
                            ...
                            return h('div', [
                                h('Button', {
                                    ...
                                    on: {
                                        click: () => {
                                            // console.log(params)
                                            Bus.$emit('showcompanydetail1',params)
                                        }
                                    }
                                }, '[查看公司]'),
                                h('Button', {
    ...
    methods:{
        getData(){
            var _self = this
            _self.Sloading = true
            var url = 'api/order/workOrderList?state=service'
            var config = {
                params:{
                    page:_self.page,
        ...
        showdetail1(){
            if(this.current_row != ''){
                Bus.$emit('myCommonTask1',this.current_row)
            }else{
        ...
        showflow1(){
            if(this.current_row != ''){
                Bus.$emit('myflow1',this.current_row)
            }else{
