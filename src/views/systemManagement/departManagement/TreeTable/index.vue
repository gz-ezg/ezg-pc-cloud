<template>
  <el-table 
    ...
    <el-table-column v-if="columns.length===0" min-width="150">
    ...
    <el-table-column v-for="(column, index) in columns" v-else :key="column.value" :label="column.text" :min-width="column.width">
      <template slot-scope="scope">
        <!-- Todo -->
