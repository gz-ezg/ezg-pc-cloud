                    ...
                    <Row :gutter="10">
                        ...
                        <Col span="22" v-if="isshow">
                            <FormItem prop="type" label="报告类型：">
                                <Select transfer v-model="searchData.type" size="small" @on-change="search" style="width:100%">
                        ...
                        <Col span="22">
                            <FormItem prop="income" label="企业收入（单位:万）：">
                                <Input size="small" v-model="searchData.income" style="width:100%" @on-enter="search" />
                            </FormItem>
                        </Col>
                    </Row>
                    <Row :gutter=10>
    ...
    methods: {
        ...
        yz_count(){
            ...
            var C5 = _self.searchData.income * 10000 + 200;
                _self.total = C5 < 500000 ? 1200 :
                C5 < 1000000 ? 1200 + (C5 - 500000) * 0.15 / 100 :
                C5 < 5000000 ? 1950 + (C5 - 1000000) * 0.04 / 100 :
                C5 < 10000000 ? 3550 + (C5 - 5000000) * 0.03 / 100 :
                C5 < 50000000 ? 5050 + (C5 - 10000000) * 0.02 / 100 :
                C5 < 100000000 ? 13050 + (C5 - 50000000) * 0.015 / 100 :
                C5 < 500000000 ? 20550 + (C5 - 100000000) * 0.01 / 100 :
                C5 < 1000000000 ? 60550 + (C5 - 500000000) * 0.008 / 100 : 100550 + (C5 - 1000000000) * 0.006 / 100;
        ...
        SJ_count(){
            ...
            this.total = C4 < 500000 ? 2000 :
                    C4 < 1000000 ? 2000 + (C4 - 500000) * 0.2 / 100 :
                    C4 < 5000000 ? 3000 + (C4 - 1000000) * 0.09 / 100 :
                    C4 < 10000000 ? 6600 + (C4 - 5000000) * 0.07 / 100 :
                    C4 < 50000000 ? 10100 + (C4 - 10000000) * 0.05 / 100 :
                    C4 < 100000000 ? 30100 + (C4 - 50000000) * 0.03 / 100 :
                    C4 < 500000000 ? 45100 + (C4 - 100000000) * 0.015 / 100 :
                    C4 < 1000000000 ? 105100 + (C4 - 500000000) * 0.01 / 100 : 155100 + (C4 - 1000000000) * 0.008 / 1000;
        ...
        ZXQJ_count(){
            ...
            this.total = C3 < 1000000 ? Math.max(1500, C3 * 0.3 / 100) :
                 C3 < 5000000 ? 3000 + (C3 - 1000000) * 0.1 / 100 :
                 C3 < 10000000 ? 7000 + (C3 - 5000000) * 0.05 / 100 :
                 C3 < 50000000 ? 9500 + (C3 - 10000000) * 0.03 / 100 :
                 C3 < 100000000 ? 21500 + (C3 - 50000000) * 0.02 / 100 :
                 C3 < 500000000 ? 31500 + (C3 - 100000000) * 0.01 / 100 :
                 C3 < 1000000000 ? 71500 + (C3 - 500000000) * 0.005 / 100 : 96500 + (C3 - 1000000000) * 0.002 / 100;
