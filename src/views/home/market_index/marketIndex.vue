  ...
  <div style="min-width:1100px">
    <Row style="border-bottom:1px solid #F5F5F5">
      <Col span="16" style="background-color:#FFFFFF;padding:10px">
        <div>
          ...
          <Col span="5" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="connection-bars" style="margin-right:10px"></Icon>全国销售排名
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{userTableData.person.rowNo}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
          <Col span="5" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="person" style="margin-right:10px"></Icon>新增客户
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{userTableData.person.new_customer}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
          <Col span="5" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="checkmark-circled" style="margin-right:10px"></Icon>交易总额
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{userTableData.person.sumrealnumber}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
          <Col span="5" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="ios-pie" style="margin-right:10px"></Icon>剩余业绩
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{userTableData.person.target_amount}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
      ...
      <Col span="8" style="background-color:#FFFFFF;padding:10px;border-left:1px solid #F5F5F5">
        <div>
          <Col span="24" style="padding:13px">
            <center>
              <Button type="text" @click="openTeamTotal">
                <h2>本月团队业绩统计</h2>
              </Button>
            </center>
          </Col>
          <Col span="11" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="person" style="margin-right:10px"></Icon>新增客户数
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{userTableData.team.new_customer}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
          <Col span="11" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              ...
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{userTableData.team.sumrealnumber}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
      ...
      <Col span="16" style="background-color:#FFFFFF;padding:10px;">
        <div>
          ...
          <Col span="24" style="margin-top:-15px">
            <center>
              <Button size="small" type="text" @click="showHistory">查看历史计划</Button>
            </center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本日销售目标</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本日完成</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本日计划新增客户</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本日新增客户</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本日计划拜访</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本日拜访</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.day.saleroom}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.day.finish_saleroom}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.day.new_customer_num}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.day.finish_new_customer_num}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.day.visit_num}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.day.finish_visit_num}}</center>
          </Col>

          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本周销售目标</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本周完成</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本周计划新增客户</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本周新增客户</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本周计划拜访</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5;background-color:#F5F5F5">
            <center style="padding:10px">本周拜访</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.week.saleroom}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.week.finish_saleroom}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.week.new_customer_num}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.week.finish_new_customer_num}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.week.visit_num}}</center>
          </Col>
          <Col span="4" style="border:1px solid #F5F5F5">
            <center style="padding:10px">{{UserPlanData.week.finish_visit_num}}</center>
          </Col>
        </div>
      </Col>
      <Col span="8" style="background-color:#FFFFFF;padding:10px;border-left:1px solid #F5F5F5">
        <div style="height:236px">
          ...
          <Col span="11" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="person" style="margin-right:10px"></Icon>本年销售目标
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{UserPlanData.year.year_target_num}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
          <Col span="11" style="margin:10px 2% 10px 2%;text-align:center">
            <Card>
              <Icon type="checkmark-circled" style="margin-right:10px"></Icon>本年已完成
              <Row style="padding-top:10px;">
                <center>
                  <h2>{{UserPlanData.year.year_realnumber}}</h2>
                </center>
              </Row>
            </Card>
          </Col>
    ...
    <Row style="margin-top:1px">
      <Col span="16" :style="{marginBottom: '10px'}">
        <Card style="height:650px">
          <p slot="title" class="card-title">
            <Icon type="android-map"></Icon>客户成交周期
          </p>
      ...
      <Col span="8" :style="{marginBottom: '10px'}">
        <Card style="height:650px">
          <p slot="title" class="card-title">
            <Icon type="android-map"></Icon>二次成交比例
          </p>
          <div class="data-source-row">
    ...
    <div class="market_hover">
      <Card style="width:60px;height:250px;">
        ...
        <div @click="openCal">
          <Row>
            <Col span="24">
              <Icon type="calculator" size="38"></Icon>
              <p style="font-size:10px">报价</p>
            </Col>
          </Row>
        </div>
        <div @click="open_pay_code">
          <Row>
            <Col span="24">
              <Icon type="social-yen" size="32"></Icon>
              <p style="font-size:10px">支付</p>
            </Col>
          </Row>
        </div>
        <div @click="open_fangan_code">
          <Row>
            <Col span="24">
              <Icon type="android-contacts" size="28"></Icon>
              <p style="font-size:10px">方案</p>
            </Col>
          </Row>
        </div>
      </Card>
    </div>
    <Modal v-model="baojia" title="报价工具" width="500">
      <baojia></baojia>
      <div slot="footer"></div>
    </Modal>
    <Modal
    ...
    <Modal title="微信支付码" v-model="openPayCode" width="300">
      <Row>
        <center>
    ...
    <Modal title="方案工具二维码" v-model="openFangAnCode" width="300">
      <Row>
        <center>
    ...
    <!-- 到期客户弹窗 -->
    <Modal title="到期客户" v-model="openExpireCustomer" width="1000">
      <Table :columns="expiredCustomerColumns" :data="expiredCustomerData"></Table>
      <Page :total="expiredCustomerTotal" show-total @on-change="changeExpiredCustomerPage"/>
    </Modal>
...
export default {
  ...
  methods: {
    ...
    open_fangan_code() {
      ...
      let url =
        `http://tools.zgcfo.com/#/project/` + localStorage.getItem("id");
    ...
    getExpiredCoustomer() {
      ...
      function success(res) {
        if (res.data.msgCode === "40000") {
            //渲染数据和总数
          _self.expiredCustomerData = res.data.data.rows;
          _self.expiredCustomerTotal = res.data.data.total;
          //通过存储上次弹窗时间，实现一天弹窗一次,一天86400000毫秒
          let lastTimeAlert = localStorage.getItem("lastTimeAlert");
          if (Date.now() - lastTimeAlert >= 86400000) {
            _self.openExpireCustomer = true;
            localStorage.setItem("lastTimeAlert", Date.now());
          } 
        }
      }
    ...
    //到期客户弹窗的分页点击跳转页码功能
    changeExpiredCustomerPage(page) {
      let url = "api/order/cycle/service/record/getExpiredCustomerList";
