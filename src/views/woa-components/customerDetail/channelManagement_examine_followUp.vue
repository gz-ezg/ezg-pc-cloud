        ...
        methods: {
            ...
            openEdi() {
                ...
                if(_self.onlymarket == false){
                    var url = '/customer/findCustomerContentById?customerId=' + _self.customerid
                }else{
                    var url = '/customer/findCustomerContentById?customerId=' + _self.customerid + '&followUpType=11,12,13,14'
                }
