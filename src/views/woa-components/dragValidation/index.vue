...
<template>
    <div class="drag" :style="{'color':drag_color}">
        <div class="drag_bg" :style="{'width':drag_bg_width + 'px'}"></div>
        <div class="drag_text">{{confirmWords}}</div>
        <!-- <div @mousedown="mousedownFn($event)" class="handler handler_bg"></div> -->
        <div @mousedown="flag && mousedownFn($event)" class="handler" :style="{'left':handler_left + 'px'}" :class="{'handler_bg':success,'handler_ok_bg':!success}"></div>        
    </div>
</template>
