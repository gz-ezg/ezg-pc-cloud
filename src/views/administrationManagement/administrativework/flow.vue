<template>
  <div>
    <Modal width="700" title="流转1" v-model="flow_show">
        ...
        <Row :gutter="16">
          <Col span="12">
            <FormItem prop="CurrentProcess" label="当前流程：">
              <Input
                size="small"
                type="text"
                v-model="current_row.CurrentProcess"
                placeholder
                readonly
              ></Input>
            </FormItem>
          ...
          <Col span="12">
            <FormItem prop="product" label="产品：">
              <Input size="small" type="text" v-model="current_row.product" placeholder readonly></Input>
            </FormItem>
          </Col>
        </Row>
        <Row :gutter="16">
          <Col span="12">
            <FormItem prop="companyname" label="归属公司：">
              <Input
                size="small"
                type="text"
                v-model="current_row.companyname"
                placeholder
                readonly
              ></Input>
            </FormItem>
          ...
          <Col span="12">
            <FormItem prop="servername" label="服务人员：">
              <Input size="small" type="text" v-model="current_row.servername" placeholder readonly></Input>
            </FormItem>
          </Col>
        </Row>
        <Row :gutter="16">
          <Col span="12">
            <FormItem prop="name" label="归属客户：">
              <Input size="small" type="text" v-model="current_row.name" placeholder readonly></Input>
            </FormItem>
          </Col>
          <Col span="12">
            <FormItem prop="departname" label="服务部门：">
              <Input size="small" type="text" v-model="current_row.departname" placeholder readonly></Input>
            </FormItem>
          </Col>
        </Row>
        <!-- <Row :gutter="16">
