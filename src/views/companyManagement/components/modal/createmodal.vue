      ...
      <Modal
            ...
            <Form :model="c_com" :rules="c_comInline" :label-width="120" ref="c_com">
                ...
                <Row>
                    ...
                    <Col span="10">
                        <FormItem label="企业来源:">
                            <Select transfer v-model="c_com.where" transfer>
                                <!--    使用何种方式渲染这个选择队列呢  -->
                ...
                <Row>
                    <Col span="10">
                        <FormItem label="企业状态:">
                            <Select transfer v-model="c_com.zhuangtai" transfer> 
                    ...
                    <Col span="10">
                        <FormItem label="重要等级:">
                            <Select transfer v-model="c_com.importLevelText" transfer>
                ...
                <Row>
                    <Col span="10">
                        <FormItem label="年度纳税评级:">
                            <Select transfer v-model="c_com.jibie" transfer>
                    ...
                    <Col span="10">
                        <FormItem label="企业交易状态:">
                            <Select transfer v-model="c_com.charge" transfer>
