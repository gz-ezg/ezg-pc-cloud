    ...
    <Card>
        ...
        <Row>
            <ButtonGroup style="float:left">
                ...
                <Button type="primary" icon="ios-color-wand-outline" @click="re_create" v-if="isAdmin">重新生成流程</Button>
...
export default {
                ...
                header: [
                    {
                        ...
                        sortable: true,                                                
                        render:(h, params) => {
                            return h('div', this.workOrderStatus_map.get(params.row.workOrderStatus))
                        }                       
                    },
                    {
                        title: '归属公司',
    ...
    methods:{
        getDataCenter(){
            ...
            function finish(res){
                _self.workOrderStatus = res.data.data.workOrderStatus
