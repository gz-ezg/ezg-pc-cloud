            ...
            <Collapse v-model="search_model">
                <Panel name="1">
                    ...
                    <div slot="content" @keydown.enter="Search">
                        <Form ref="SearchValidate" :model="SearchValidate" :label-width="130" style="margin-top: -10px">
                            <Row>
                                <Col span="6">
            ...
            get_data(){
                ...
                function success(res){
                    ...
                    _self.data = res.data.data.rows.map(item => {
                        ...
                        item.remainderA = item.remainderA == null ? '0': item.remainderA
                        item.remainderB = item.remainderB == null ? '0': item.remainderB
