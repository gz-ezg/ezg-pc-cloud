...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            editable(content,id){
                let _self = this
                _self.$bus.$emit("AMEND_IMPORT_REMIND_QUICK_LIST",content,id)
            },
            selectArr(id){
            ...
            add_schtask(){
                this.$bus.emit("ADD_IMPORT_REMIND_QUICK_LIST")
            },
        ...
        created() {
            ...
            this.$bus.on("OPEN_ADD_IMPORTANT_REMINDER",(e)=>{
