    ...
    <div>
                ...
                <Card>
                    <Row>
                        <ButtonGroup>
                            ...
                            <Button v-permission="['channelT.edit']" type="primary" icon="edit" @click="TypeEdit">编辑</Button>
                            <Button v-permission="['channelT.delete']" type="primary" icon="edit" @click="deleteType">删除</Button>
                        </ButtonGroup>
                    ...
                    <Row style="margin-top: 10px;">
                                <Tabs value="name1">
                                    <TabPane label="渠道用户" name="name1">
                                        <Row>
                                            <ButtonGroup>
                                                <Button  v-permission="['channelT.cannel.add']" type="primary" icon="plus" @click="addq('qd')">新增</Button>
                                            </ButtonGroup>
                                            <!-- <Poptip trigger="click" title="筛选" style="float:right" placement="bottom-end">
                                    ...
                                    <TabPane label="销售" name="name2">
                                        <Row>
                                            <ButtonGroup>
                                                <Button v-permission="['channelT.sales.add']" type="primary" icon="plus" @click="addq('xs')">新增</Button>
                                            </ButtonGroup>
                                        </Row>
                                        <Row style="margin-top: 10px;">
        ...
        <Modal
            ...
            <Row>
                <Col span="12">
                    <Checkbox v-model="single" v-if="!isQd">
                        ...
                        <span>是否设置该销售为主要负责人</span></Checkbox>
                            ...
                            <Form ref="UsersearchformInline" :model="UsersearchformInline" :label-width="60">
                                <Row>
                                        ...
                                        <FormItem prop="realname" label="真实姓名：">
                                            <Input type="text" v-model="UsersearchformInline.realname" placeholder="" style="width:180px">
                                            </Input>
                                        </FormItem>
                                </Row>
                                <Row>
                                        ...
                                        <FormItem prop="mobilephone" label="电话：">
                                            <Input type="text" v-model="UsersearchformInline.mobilephone" placeholder="" style="width:180px">
                                            </Input>
                                        </FormItem>
                                </Row>
                                <FormItem>
                                    <Button type="primary" @click="usersearch">搜索</Button>
                                    <Button type="ghost" style="margin-left:20px;margin-bottom:0" @click="userreset">重置</Button>
                                </FormItem>
                            </Form>
                        </div>
                    </Poptip>
            ...
            <Table
                    ...
                    :data="data3"
                    size="small"
                    @on-row-dblclick="addUserClick"></Table>
            <Page
                    size="small"
                    :total="pageTotala"
                    show-total
        ...
        methods: {
            ...
            getTableData() {
                ...
                if(_self.searchLabel ==''){
                    var url = '/channel/type/list?page='+ _self.page +'&pageSize='+ _self.pageSize
                }else{
                    var url = '/channel/type/list?page='+ _self.page +'&pageSize='+ _self.pageSize + '&channelTypeName=' + _self.searchLabel
                }
            ...
            getUser(a) {
                let _self = this
                let url = '/channel/user/list?page='+ _self.pageq +'&pageSize='+ _self.pageSizeq +'&channelTypeId='+ a +'&type=qdyh'
                let url2 = '/channel/user/list?page='+ _self.pageq +'&pageSize='+ _self.pageSizeq +'&channelTypeId='+ a +'&type=xs'
            ...
            getuserlist(){
                ...
                var keys =[]
                    ...
                    if (_self.UsersearchformInline[key] == "" || _self.UsersearchformInline[key] == null) {
