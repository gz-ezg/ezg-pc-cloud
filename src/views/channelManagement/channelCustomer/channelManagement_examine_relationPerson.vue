    ...
    <div>
        ...
        <Modal
            ...
            <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem label="发送信息" prop="sendmsgflag" >
                    <Select transfer v-model="formValidate.sendmsgflag" transfer>
        ...
        <Modal
            ...
            <Form ref="formValidate2" :model="formValidate2" :rules="ruleValidate" :label-width="80">
                ...
                <FormItem label="发送信息" prop="sendmsgflag">
                    <Select transfer v-model="formValidate2.sendmsgflag" transfer>
                        <Option value="1">是</Option>
                        <Option value="0">否</Option>
                    </Select>
                </FormItem>
    ...
    export default {
        ...
        methods: {
            ...
            getCustomerRelation() {
                var _self = this
                _self.data6 = []
                this.$http.get('/api/customer/findCustomerRelationById/' + _self.customerid[0])
