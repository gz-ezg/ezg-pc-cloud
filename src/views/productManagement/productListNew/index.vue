...
<div>
    <Card>
        ...
        <Row style="margin-top: 10px;">
            <Col span="12">
            <Table :loading="loading" highlight-row border size="small" :columns="header" @on-current-change="select_row" :data="data"></Table>
            <Page size="small" :total="total" show-total show-sizer show-elevator :current.sync="page" @on-change="page_change" @on-page-size-change="page_size_change" style="margin-top: 10px"></Page>
            </Col>
            <Col span="12">
                            ...
                            h(
                                'Button', {
                                    ...
                                    on: {
                                        click: function (event) {
                                            _self.$router.push({
                                                path: '/productDetail/' + params.row.id,
                                            })
                                        },
                                    },
                                },
