        ...
        >
            <div style="min-height:60vh;width:400px" v-if="data.length!==0">
                <Row :gutter="20" style="margin-top:20px">
                    ...
                    <Col span="18">
                        <Input v-model="fieldDetail.task_name" size="small" style="width:180px" type="textarea" :row="5" autosize>
                        </Input>
                    </Col>
                </Row>
                <Row :gutter="20" style="margin-top:20px">
                    ...
                    <Col span="18">
                        <span style="line-height:24px">{{fieldDetail.CompanyName}}
                            </span>
                    </Col>
                </Row>
                <Row :gutter="20" style="margin-top:20px">
                    ...
                    <Col span="18">
                        <span style="line-height:24px">{{fieldDetail.name}}<span style="margin-left: 10px"><Button v-if="fieldDetail.name!==null" type="primary" size="small" @click="open_customer_detail">客户详情</Button></span></span>
                    </Col>
                </Row>
                <Row :gutter="20" style="margin-top:20px">
                    <Col span="6">
                    ...
                    <Col span="18">
                        <span style="line-height:24px">{{fieldDetail.task_kind}}</span>
                    </Col>
                </Row>
                <Row :gutter="20" style="margin-top:20px">
                    <Col span="6">
                    ...
                    <Col span="18">
                        <span style="line-height:24px">{{fieldDetail.service_content}}</span>
                    </Col>
                </Row>
                <Row :gutter="20" style="margin-top:20px">
                    <Col span="6">
                    ...
                    <Col span="18">
                        <DatePicker v-model="fieldDetail.plan_date" size="small" style="width:180px" type="datetime" @on-change="getPlanTime" disabled>
                        </DatePicker>
                    </Col>
                </Row>
                <Row :gutter="20" style="margin-top:20px">
            ...
            <div slot="footer">
                <Button @click="openTaskDetail = false" type="primary"  style="margin-left:40px"  :loading="loading">关闭</Button>
            </div>
        </Modal>
        <create></create>
    </div>
        ...
        methods:{
            ...
            get_field_detail(e){
                ...
                function success(res){
                    ...
                    _self.fieldDetail.task_kind = _self.taskKind_map.get(res.data.data.task_kind)
