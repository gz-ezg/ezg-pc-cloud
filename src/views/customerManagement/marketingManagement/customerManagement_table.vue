                    ...
                    <div slot="content" v-if="issearch" @keydown.enter="Search">
                        <Form ref="formValidate" :model="formValidate" :label-width="75" style="margin-top: 15px">
                            ...
                            <Row :gutter="16">
                                <Col span="12">
                                <FormItem label="客户状态：" prop="customerType	">
                                     <Cascader trigger="hover" :data="customerType" v-model="formValidate.customerType" size="small"></Cascader>
                                </FormItem>
                                </Col>
                                <Col span="12">
                            ...
                            <Row :gutter="16">
                                <Col span="12">
                                    <FormItem label="客户来源：" prop="customersource">
                                        <Select transfer v-model="formValidate.customersource" size="small" @on-change="Search" style="width:200px ">
                                            <Option v-for="item in cluesource" :value="item.typecode" :key="item.id" >
                                                {{ item.typename }}
                                            </Option>
                                        </Select>
                                ...
                                <Col span="12">
                                <FormItem label="渠道名称：" prop="channelTypeName">
                                    <Input v-model="formValidate.channelTypeName" size="small" style="width: 200px"></Input>
                                </FormItem>
                                </Col>
                            </Row>
                            <Row :gutter="16">
                              <Col span="12">
                                <FormItem label="微信绑定：" prop="isbound">
                                    <Select transfer v-model="formValidate.isbound" size="small" @on-change="Search" style="width: 200px">
                                        <Option value="">     </Option>
                                         <Option v-for="item in isboundValue" :value="item.value" :key="item.value">
                                            {{ item.label }}
                                        </Option> 
                              ...
                              <Col span="12">
                                <FormItem label="创建时间：" prop="credate">
                                    <DatePicker type="daterange"   style="width: 200px" v-model="formValidate.credate" placement="bottom-end" size="small"></DatePicker>
                                </FormItem>
                                </Col>
                            </Row>
                            <Row :gutter="16">
                              <Col span="12">
                                <FormItem label="更新时间：" prop="upddate">
                                    <DatePicker type="daterange"   style="width: 200px" v-model="formValidate.upddate" placement="bottom-start" size="small"></DatePicker>
                                </FormItem>
                                </Col>
                            </Row>
                            <center>
        ...
        },
          {
              ...
              render: (h, params) => {
                ...
                if(params.row.companyNames == ''|| params.row.companyNames == null){
                  ...
                  //     }
                  // }, [
                  //     h('span', this.data[params.index].companyNames[0].name.slice(0,10) + '...'),
                  //     h('Icon', {
                  //         props: {
                  //             type: 'arrow-down-b',
                  //         }
