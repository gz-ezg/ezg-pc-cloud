...
export default {
    ...
    methods: {
        ...
        create(){
            ...
            let url = `api/customer/addCustomerRelation`
            ...
            function success(res){
                _self.loading = false
                _self.openRelationCreate = false
    ...
    created(){
        let _self = this
        this.$bus.on("CREATE_CUSTOMER_RELATION", (e)=>{
            this.openRelationCreate = true
        })
    }
}
</script>
