        ...
        <Card>
            <Form ref="formValidate" :model="formValidate" :label-width="80">
                ...
                <FormItem label="区域" prop="area" style="margin-bottom:0px">
                    <Select transfer v-model="formValidate.area" size="small" disabled transfer>
    ...
    export default {
        ...
        methods: {
            getDataCenter() {
                ...
                let parmas = "customerTypes,cluesources,customerrating,area"
            ...
            getData() {
                ...
                this.$http.all([
                    this.$http.get('/api/customer/findCustomer/' + _self.customerid[0]),
