            ...
            >
                ...
                <Row>
                    ...
                    <FormItem label="单位名称" prop="enterprise_name" >
                        <Input v-model="invoiceTemplate.enterprise_name" placeholder="" readonly></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="12">
                        <FormItem label="发票类型" prop="invoice_type">
                            <Input v-model="invoiceTemplate.invoice_type" placeholder="" readonly></Input>
                        </FormItem>
                    </Col>
                    <Col span="12">
                    <FormItem label="纳税人识别号" prop="tax_num">
                        <Input v-model="invoiceTemplate.tax_num" placeholder="" readonly></Input>
                    </FormItem>
                    </Col>
                </Row>
                <Row>
                    <Col span="12">
                        <FormItem label="发票内容" prop="invoice_content">
                            <Input v-model="invoiceTemplate.invoice_content" placeholder="" readonly></Input>
                        </FormItem>
                    </Col>
                    <Col span="12">
                        <FormItem label="开票金额" prop="tax_money">
                            <Input v-model="invoiceTemplate.tax_money" placeholder="" readonly></Input>
                        </FormItem>
                    </Col>
                </Row>
                <Row v-if="invoiceTemplate.invoice_type == '增值税专用发票' || invoiceTemplate.invoice_type == '专用发票'">
                    <FormItem label="注册地址" prop="register_address">
                        <Input v-model="invoiceTemplate.register_address" placeholder="" readonly></Input>
                    </FormItem>
                    <FormItem label="注册电话" prop="register_tel">
                        <Input v-model="invoiceTemplate.register_tel" placeholder="" readonly></Input>
                    </FormItem>
                    <FormItem label="开户银行" prop="bank">
                        <Input v-model="invoiceTemplate.bank" placeholder="" readonly></Input>
                    </FormItem>
                    <FormItem label="银行账户" prop="bank_account">
                        <Input v-model="invoiceTemplate.bank_account" placeholder="" readonly></Input>
                    </FormItem>
                </Row>
                <FormItem label="领取方式" prop="express_type">
                    <Input v-model="invoiceTemplate.express_type" placeholder="" readonly></Input>
                </FormItem>
                <Row v-if="invoiceTemplate.express_type == '快递'">
                    <FormItem label="接收人" prop="receiver">
                        <Input v-model="invoiceTemplate.receiver" placeholder="" readonly></Input>
                    </FormItem>
                    <FormItem label="联系方式" prop="receiver_mobile">
                        <Input v-model="invoiceTemplate.receiver_mobile" placeholder="" readonly></Input>
                    </FormItem>
                    <FormItem label="收件地址" prop="receiver_address">
                        <Input v-model="invoiceTemplate.receiver_address" placeholder="" readonly></Input>
                    </FormItem>
                </Row>
                <FormItem label="邮箱" prop="email" v-if="invoiceTemplate.express_type == '邮箱'">
                    <Input v-model="invoiceTemplate.email" placeholder="" readonly></Input>
                </FormItem>
                <FormItem label="备注" prop="tax_memo">
                    <Input v-model="invoiceTemplate.tax_memo" placeholder="" type="textarea" row="5" readonly></Input>
                </FormItem>
