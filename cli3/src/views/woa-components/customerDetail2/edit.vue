    ...
    <div>
        <Form ref="formValidate" :rules="ruleValidate" :model="formValidate" :label-width="80">
            ...
            <FormItem label="服务地址" prop="ADDRESS" style="margin-bottom:0px">
                <Input size="small" v-model="formValidate.ADDRESS" readonly/>
            </FormItem>
            <FormItem label="客户状态" prop="customerType" style="margin-bottom:0px">
                <Cascader trigger="hover" :data="customerTypes_Casr" v-model="formValidate.customerType" disabled></Cascader>
            </FormItem>
            ...
            <FormItem label="渠道名称" prop="channel_type_id" v-if="formValidate.customersource == 'xzqd'" style="margin-bottom:0px">
                <Select transfer v-model="formValidate.channel_type_id" size="small" disabled>
            ...
            <FormItem label="重要性" prop="importance" style="margin-bottom:0px">
                <Select transfer v-model="formValidate.importance" size="small" disabled>
            ...
            <FormItem label="发送短信" prop="issends" style="margin-bottom:0px">
                <Select transfer v-model="formValidate.issends" size="small" disabled>
            ...
            <FormItem label="标签" prop="customerlabelTags" style="margin-bottom:0px">
                <Tag v-for="(item, index) in LabelArray" :key="index" :name="index">{{ item.labelName }}</Tag>
            ...
            <FormItem label="备注" prop="backup" style="margin-bottom:10px">
                <Input size="small" type="textarea" v-model="formValidate.backup" readonly/>
            </FormItem>
...
export default {
    ...
    methods: {
        get_data(e){
            ...
            function fail(err){
                _self.$Message.error("对不起，你选择的客户暂时没有找到相关信息，请确认后重试！2秒后页面将关闭！")
                setTimeout(()=>{
                    _self.$store.commit('close_gobal_customer_detail_modal');
                },2000)
            }
